...
public class Player extends Entity {
    ...
    public void setDefaultProperties(){
        ...
        projectile = new Projectile(new Arrow(gamePanel));
        attack = getAttack();
        defense = getDefense();
    ...
    public void updateScreen(){
        ...
        if(inputHandler.projectile && !projectile.alive && projectileCounter == projectile.itemAsEntity.useFrequency){
            castProjectile();
            projectileCounter = 0;
        }
        ...
        if (projectileCounter < projectile.itemAsEntity.useFrequency){
            projectileCounter++;
        }
    }

    private void castProjectile() {
        //SET STARTING POS; DIRECTION AND USER
    ...
    public void damageFoe(int index, int attack){
        if (index != 999){
